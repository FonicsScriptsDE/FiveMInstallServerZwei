#    Copyright (C) 2024  FonicsScriptsDE.
#
...
while getopts ":sh" option; do
  case $option in
    h )
      ...
      echo
      echo "Syntax: bash <(curl -s https://raw.githubusercontent.com/FonicsScriptsDE/PHPMyAdminInstallerFonicsScriptsDE/main/install.sh) [-h|-s]"
      echo
      echo "options:"
...
source <(curl -s https://raw.githubusercontent.com/FonicsScriptsDE/PHPMyAdminInstallerFonicsScriptsDE/main/BashSelect.sh)
